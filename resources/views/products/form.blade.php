...
<div class="space-y-5">
        ...
        <div>
                ...
                <div class="flex flex-wrap gap-3 mb-3">
                    @foreach($product->images as $imgPath)
                        <label class="relative cursor-pointer group">
                            ...
                            <img src="{{ \App\Helpers\ImageUrlHelper::getProductImageUrl($imgPath) }}"
            ...
            @elseif(!empty($product->image))
                <div class="flex flex-wrap gap-3 mb-3">
                    <img src="{{ \App\Helpers\ImageUrlHelper::getProductImageUrl($product->image) }}" class="w-24 h-24 object-cover border-2 border-[#bdbdbd]">
                </div>
            @endif
