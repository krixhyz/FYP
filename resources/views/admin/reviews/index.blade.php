...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
    <div class="p-5 border-b border-gray-100">
        <h2 class="font-semibold">All Reviews</h2>
    </div>
            ...
            <tbody class="divide-y divide-gray-100">
                @forelse ($reviews as $review)
                    <tr class="hover:bg-gray-50">
                        <td class="p-3 text-gray-400">{{ $review->id }}</td>
                        ...
                        <td class="p-3 text-gray-600 max-w-xs truncate">{{ $review->body ?? '—' }}</td>
                        <td class="p-3 text-gray-400 text-xs">{{ $review->created_at->format('Y-m-d') }}</td>
                    </tr>
                @empty
                    <tr><td colspan="7" class="p-5 text-center text-gray-400">No reviews yet.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
