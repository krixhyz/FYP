<div class="flex items-start gap-3 bg-[#fffbeb] border border-[#fde68a] px-4 py-3 rounded-sm">
    <svg class="shrink-0 mt-0.5 w-4 h-4 text-[#b45309]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01M5.07 19H19a2 2 0 001.75-2.97L13.75 4a2 2 0 00-3.5 0L3.25 16.03A2 2 0 005.07 19z"/>
    </svg>
