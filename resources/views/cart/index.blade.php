...
<div class="px-8 md:px-16 py-12">
    ...
    <div data-cart-items-wrapper>
        <div class="bg-[#f3f3f3] px-8 md:px-16 py-16 text-center {{ $cartItems->isEmpty() ? '' : 'hidden' }}" data-cart-empty-state>
        ...
        <div class="{{ $cartItems->isEmpty() ? 'hidden' : '' }}" data-cart-items-list>
            ...
            <!-- Order Summary -->
            <div class="bg-[#f3f3f3] px-6 py-6 space-y-4" data-cart-summary-panel>
                <div class="flex justify-between items-center">
                    <p class="font-space text-sm font-bold uppercase tracking-widest text-[#444746]">Grand Total</p>
                    <p class="font-space font-bold text-2xl text-[#006a38]" data-cart-grand-total data-raw-value="{{ $grandTotal }}">Rs. {{ number_format($grandTotal,2) }}</p>
                </div>
