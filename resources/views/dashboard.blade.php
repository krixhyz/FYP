...
<div class="lg:col-span-2">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        ...
        <div id="dashboard-notification-list" class="p-6 space-y-6 min-h-[200px]">
            @php
                $grouped = [
                    'requests' => [],
                    'accepted' => [],
    ...
    try {
        ...
        function prependNotificationToDashboard(message, redirectUrl, id, type = 'general') {
            ...
            item.className = 'notification-item flex items-start space-x-4 p-4 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors block';
            ...
            item.innerHTML = `
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-gray-900 dark:text-white">${safeMessage}</p>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">just now</p>
                    <div class="mt-2">
                        <span class="text-blue-600 dark:text-blue-400 text-xs font-medium hover:underline">View →</span>
                    </div>
                </div>`;
